          ...
          <ScrollReveal>
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-xs text-charcoal-muted/50 uppercase tracking-wider font-medium">WhatsApp / Phone</div>
                  <div className="text-charcoal font-medium">+91 63746 03180</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-xs text-charcoal-muted/50 uppercase tracking-wider font-medium">Instagram</div>
                  <a href="https://www.instagram.com/paprish_foods?igsh=MXQ2YWJ1cmI4eTFiYw==" target="_blank" rel="noopener noreferrer" className="text-charcoal font-medium hover:text-paprish-600 transition-colors">
                    @paprish_foods
                  </a>
                </div>
              </div>
