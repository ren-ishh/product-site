...
const features = [
  {
    ...
    description:
      "Every ingredient is traceable to its origin. We work exclusively with certified farms and suppliers who share our commitment to purity.",
  },
  {
    icon: (
      <svg
    ...
    title: "Lab Tested",
    description:
      "Multiple quality checkpoints from sourcing to packaging. Each batch undergoes thorough testing for purity, adulterants, and freshness.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Packed in a controlled environment with minimal human contact. Our packaging locks in freshness and keeps contaminants out.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "We don't stockpile. Products are packed in small batches and dispatched quickly so what reaches you is always at its peak.",
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <ScrollReveal>
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-paprish-400">
                Quality Promise
              </span>
            </div>
            ...
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold leading-[1.15] tracking-tight mb-6">
              ...
              <br />
              corners.{" "}
              <span className="text-paprish-400 italic">Ever.</span>
            </h2>

            <p className="text-white/50 leading-relaxed max-w-md mb-10 text-base">
              Quality isn't a department at Paprish — it's the foundation of
              everything we do. From farm to packet, every step is designed to
              preserve what nature intended.
            </p>

            {/* Highlight stat */}
            <div className="flex items-center gap-6 p-6 rounded-2xl bg-white/[0.03] border border-white/[0.06]">
              <div className="font-serif text-5xl font-bold text-paprish-400 leading-none">
                100%
              </div>
              <div>
                ...
                <div className="text-white/40 text-xs leading-relaxed mt-1">
                  Not happy with the quality? We'll make it right — no questions
                  asked.
                </div>
              </div>
            </div>
            ...
            {features.map((feature, i) => (
              <ScrollReveal key={feature.title} delay={i * 100}>
                <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 hover:bg-white/[0.06] transition-colors duration-300 group h-full">
                  ...
                  <h4 className="font-serif font-semibold text-white mb-2 text-base">
                    {feature.title}
                  </h4>
